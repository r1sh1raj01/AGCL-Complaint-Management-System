            ...
            <div class="login-box">
                ...
                <form action="EmployeeLoginServlet" method="post">
                    <div class="input-group">
                        ...
                        <input type="text" id="email" name="user" required value="<%= request.getAttribute("savedEmail") != null ? request.getAttribute("savedEmail") : "" %>">
                    </div>
                    <div class="input-group">
                        <label for="password">Password</label>
                        <input type="password" id="password" name="password" required value="<%= request.getAttribute("savedPassword") != null ? request.getAttribute("savedPassword") : "" %>">
                        <button type="button" class="toggle-password">
                            <img src="images/view.png" id="togglePasswordIcon">
                        </button>
                    </div>
                    <div class="remember-me">
                        <input type="checkbox" id="remember" name="remember" <%= request.getAttribute("savedRemember") != null ? "checked" : "" %>>
