...
<head>
    ...
    <script src="js/employeeDashboard.js"></script> <!-- External JavaScript file -->
</head>
<body>
    <header>
        <div class="container">
            ...
            <nav>
                <ul>
                    ...
                    <li><a href="ComplaintForm.jsp">Raise Complaint</a></li>
					<li><a href="ViewComplaintServlet">View My Complaints</a></li>
    ...
    <main>
        <div class="container">
            ...
            <section class="quick-actions">
                <h2>Quick Actions</h2>
                <button onclick="window.location.href='ComplaintForm.jsp'">Raise a Complaint</button>
                <button onclick="window.location.href='ViewComplaintServlet'">View My Complaints</button>
            </section>
